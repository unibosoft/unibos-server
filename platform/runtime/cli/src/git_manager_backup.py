...
# -*- coding: utf-8 -*-
"""
🪐 unibos v084 - enhanced git manager
complete git operations with fixed UI positioning
clean interface with proper content area management

author: berk hatırlı - bitez, bodrum, muğla, türkiye
version: v084_20250715_2353
purpose: full git functionality with seamless main UI integration
"""
